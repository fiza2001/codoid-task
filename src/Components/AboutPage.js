...
export default function AboutPage(params) {
  return (
    ...
    <div className="about-main">
      ...
      <img className="about-img" src={require("./about1.jpg")} alt="" />
      <div className="about-content-main">
        <div className="about-content">
          ...
          <p>
            ...
            best days lay ahead of us. On the road. By the sea. Atop a mountain
            ...
            different to home, we would be rootless and lost. Travel is what
